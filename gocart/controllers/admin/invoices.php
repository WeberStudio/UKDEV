...
class Invoices extends Admin_Controller {    
	...
	function pdf_view($invoice_id, $template_id)
    {
        ...
        $mpdf->SetHeader('{DATE d-m-Y}|{PAGENO}|Supplier Invoice');
//        $this->mpdf->Image($image1);   
        ...
        $html_output         .='
                ...
                <div class="box paint color_24" style="opacity:1.0;">
        ...
        $r_tag_two             = htmlspecialchars_decode(stripslashes($selected_template->invoice_template_footer)); 
