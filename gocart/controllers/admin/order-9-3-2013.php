...
*/
	...
	function pdf_view($order_id)
    {
        ...
        $html_output         .= '<br/><table id="item_table" class="" style="width:100%; font-size:12px;"  cellpadding="0" cellspacing="0" >
                                <thead>
                                  <tr>
                                    <th>Order Number</th>
                                ...
                                <tbody>';
                                     ...
                                     $html_output         .=  '
                                      <tr id="new_item" >
                                         <td style="vertical-align: top;">'.$order->order_number.'</td>  
                                       	 <td style="vertical-align: top;">'.$order->bill_company.'<br/>'.$order->bill_firstname.' '.$order->bill_lastname.'<br>'.$order->bill_address1.', '.$order->bill_address2.'<br>'.$order->bill_city.', '.$order->bill_zone.', '.$order->bill_zip.'<br>'.$order->bill_country.', '.$order->bill_email.', '.$order->bill_phone.'</td>                    
        ...
        $html_output         .= '<table id="item_table" class="" cellspacing="20" style="width:100%; font-size:12px;">
                                <thead>
                                  <tr>
                                    <td><b>Qty</b></td>
                                    <td ></td> 
