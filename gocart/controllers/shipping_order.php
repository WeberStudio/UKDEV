...
class Shipping_order extends Front_Controller {	
    ...
    function delivery_address()
    {
        ...
        if($this->input->post('continue')!=""){        
            ...
            'street_address'    => $this->input->post('dstreet_address'),
            'address_line2'        => $this->input->post('daddress_line2'),
            'city'                => $this->input->post('dcity'),
            'state'                => $this->input->post('dzone_id'),
            'post_code'            => $this->input->post('dpost_code'),
            'country_id'        => $this->input->post('dcountry_id'),
            'email'                => $this->input->post('demail'),
            'type'                => $this->input->post('type'),
            'telephone'            => $this->input->post('dphone')
            );
