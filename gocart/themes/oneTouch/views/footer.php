...
?>
        ...
        <div class="row">
            ...
            <a target="_blank" href="https://twitter.com/UKOpen" ><img align="right" style="margin-left: 10px; margin-top: 5px" src="<?php echo theme_img("img/twiter-logo.png");?>" alt=""></a>
            <a target="_blank" href="http://www.linkedin.com/company/uk-open-college/products?trk=tabs_biz_product" ><img align="right" style="margin-left: 10px; margin-top: 5px" src="<?php echo theme_img("img/link-in.png");?>" alt=""></a>
            <a target="_blank" href="http://www.youtube.com/watch?v=4dabsHc8yNE&feature=youtube" ><img align="right" style="margin-left: 10px; margin-top: 5px" src="<?php echo theme_img("img/youtube.png");?>" alt=""></a>
 ...
 <div class="row">
            ...
            Copyrights @ 2013 & All Rights Reserved
             ...
             <div class="footerlinks">
                 <a href="<?php echo site_url('tutor_login');?>"  style="font-size:12px;"><?php echo "Tutor Login"; ?></a> / <a href="about-us">About Us</a>  / <a href="cancellation-returns">Cancellation Returns</a> / <a href="student-feedback">Student Feedback</a> / <a href="corporate-clients">Corporate Clients</a> / <a href="student-forum">Student Forum</a> / <a href="privacy-policy">Privacy Policy</a> / <a href="terms-of-service">Terms of Service</a> 
            </div>
        </div> 
 </section>   
</div>
