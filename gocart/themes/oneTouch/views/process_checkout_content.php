...
<div class="col2-set" id="customer_details">
	...
	<p align="right">
        ...
        <a  target="_blank" href="<?=base_url()?>checkout/place_order"> <img src="<?php echo theme_img('pay_cards/btn_xpressCheckout.gif');?>"    alt="Click here to pay via PayPal Express Checkout" style="width: 142px;"> </a>
