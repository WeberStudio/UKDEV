        ...
        <div class="col12">
            ...
            <div class="col6">
                ...
                <form action="<?=base_url()?>checkout/place_order_paypal_pro" method="POST" autocomplete="on" class="padding-left-right">
                    ...
                    <p class="username">C.V.V Number <a href="javascript:void(0);" onClick="popup();"><img style="height: 18px; float:right; margin-left: 10px; margin-top: -19px;" src="<?php echo base_url()."gocart/themes/UKOCNewDesign/assets/img/info_marl.png" ?>" /> </a></p>
                    <input type="text" name="cardnumber" id="cardnumber"  placeholder="" autocomplete="off" required />
                    <!--<label for="email">Email</label>-->
                    <div class="col6">
