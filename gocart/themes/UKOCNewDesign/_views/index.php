                    ...
                    <section class="banner-area">
                            ...
                            <article class="slider-wrapper">
                                ...
                                <div class="featured-course blue-featured-<?php echo $i;?>">
                                 <p style="padding-top: 165px;text-align: center;font-size: 22px;"><b style="color: white;"><?php echo $menu_category['category']->name;?></b></p>
                                </div>
</a>
                 ...
                 <div class="onerow">
                    ...
                    <div class="col4 nus-res">
                        <!--<img src="<?php echo theme_assets('img/image_nus.png');?>" alt="NUS Extra Card" />-->
						 <a href="<?php echo base_url().$special_pages->slug?>"><img style="width:380px; height:190px;" src="<?php echo 'http://87.106.234.213/uploads/images/full/'.$special_pages->image //theme_assets('img/image_nus.png');?>"  /> </a>
                 ...
                 <div class="onerow">
                    ...
                    <?php
                     ...
                     foreach($grid_pages as $grid_page){
                      ...
                      <div class="col4 nus-res">
                           <a href="<?php echo $grid_page->slug;?>"> <img style="width:380px; height:190px;" src="<?php echo 'http://87.106.234.213/uploads/images/full/'.$grid_page->image //theme_assets('img/image_nus.png');?>"  />  </a>
