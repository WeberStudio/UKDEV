                    ...
                    <section class="banner-area">
                                    ...
                                    <div id="slides">
                                      <div class="slides_container">
                                        ...
                                        <div class="slide"> <img src="<?php echo theme_assets('img/image_1.png')?>" alt="Slide1">
                                        </div>
                                        
                                        <div class="slide"> <img src="<?php echo theme_assets('img/image_2.png')?>" alt="Slide2">
                                        </div>
                            ...
                            <article class="slider-wrapper">
                                ...
                                <div class="featured-course blue-featured-<?php echo $i;?>">
                                    <a href="<?php echo base_url().$menu_category['category']->slug?>"><?php echo $menu_category['category']->name;?></a>
                                </div>
