<div class="span3" style="margin-left:80px; width:245px;">
          ...
          <div class="content">
			...
			<li class="left_panal"><a href="<?= base_url();?>dashboard/"><i class="gicon-dashboard"></i>Dashboard</a></li>
              <li class="left_panal"><a href="<?= base_url();?>dashboard/my_profile"><i class="gicon-user"></i>Profile</a></li>
              <li class="left_panal"><a href="<?= base_url();?>dashboard/course"><i class="gicon-course"></i>My Course</a></li>
              <li class="left_panal"><a href="<?= base_url();?>dashboard/fourm"><i class="gicon-fourm"></i>My Tutor(s)</a></li>
              <li class="left_panal"><a href="<?= base_url();?>dashboard/file_manager"><i class="gicon-filemanager"></i>File Manasger</a></li>
              <li class="left_panal"><a href="<?= base_url();?>tutor_login/logout"><i class="gicon-logout"></i>Log Out</a></li>
              <?php }?>
              <?php if(!empty($this->customer['id'])){?>
             
              <li class="left_panal"><a href="<?= base_url();?>dashboard/"><i class="gicon-dashboard"></i>Dashboard</a></li>
              <li class="left_panal"><a href="<?= base_url();?>dashboard/my_account"><i class="gicon-user"></i>Profile</a></li>
              <li class="left_panal"><a href="<?= base_url();?>dashboard/course"><i class="gicon-course"></i>My Course</a></li>
              <li class="left_panal"><a href="<?= base_url();?>dashboard/fourm"><i class="gicon-fourm"></i>My Tutor(s)</a></li>
              <li class="left_panal"><a href="<?= base_url();?>dashboard/file_manager"><i class="gicon-filemanager"></i>File Manasger</a></li>
               <li class="left_panal"><a href="<?= base_url();?>secure/logout"><i class="gicon-logout"></i>Log Out</a></li>
              <?php }?>
