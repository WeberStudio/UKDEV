    ...
    <div class="row-fluid">
      <div class="span12">
        <div class="box paint color_5">
          <div class="title">
            <div class="row-fluid">
              <h4>Student Invoice form</h4>
            </div>
          </div>
          <div class="content"> <?php echo form_open_multipart($this->config->item('admin_folder').'/customer_invoice/form/'); ?>
            <div class="tab-content">
              <div class="tab-pane active" id="description_tab">
                <fieldset>
                <select data-placeholder="Choose student for invoice" class="chzn-select" name="users"  tabindex="5">
                  <option value="">Choose student for invoice</option>
                  <? if(isset($users)){  ?>
