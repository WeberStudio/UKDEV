          ...
          <div class="box paint color_11">
            <div class="title">
             <h4> <i class=" icon-bar-chart"></i>
			 	<span>System Templates <a class="btn" href="<?php echo site_url($this->config->item('admin_folder').'/system_templates/form'); ?>">New Template</a></span>
			 </h4>
             </div>  
...
<table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
	...
	<tbody>
		...
		<tr>
			<td style="width:16px;"><?php  echo  $template->email_id; ?></td>			
			<td class="gc_cell_left"><?php echo  $template->email_type; ?></td>
			<?php /*?><td><?php echo  $template->invoice_template_level; ?></td><?php */?>
			
			<td>
				<div class="btn-group" style="float:right">
					<a class="btn" href="<?php echo site_url($this->config->item('admin_folder').'/system_templates/form/'.$template->email_id); ?>"><i class="icon-pencil"></i> <?php echo lang('edit');?></a>
					<a class="btn btn-danger" href="<?php echo site_url($this->config->item('admin_folder').'/system_templates/delete/'.$template->email_id); ?>" onclick="return areyousure();"><i class="icon-trash"></i> <?php echo lang('delete');?></a>
				</div>
			</td>
		</tr>
<?php endforeach; ?>
